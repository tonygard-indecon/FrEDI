...
```{r test_scalars}
test_systemData$slrImpacts$scaled_impacts %>% range(na.rm=T)
...
time3 <- Sys.time()
test1 <- testInputs$ramp %>% run_fredi(sectorList = c_sectorsList, aggLevels="all", maxYear=2300)
